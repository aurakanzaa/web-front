...
<section class="welcome-area">
        <div class="welcome-slides owl-carousel">
            ...
            <div class="single-welcome-slide">
                ...
                <div class="background-curve">
                    <img src="<?php echo base_url('')?>/assets/img/core-img/curve-1.png" alt="">
                </div>
                        ...
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="welcome-text">
                                    ...
                                    <a href="<?php echo site_url('Testing')?>" class="btn uza-btn btn-2" data-animation="fadeInUp" data-delay="700ms">Test</a>
                                </div>
                            </div>
                            <!-- Welcome Thumbnail -->
                            <div class="col-12 col-md-6">
                                <div class="welcome-thumbnail">
                                    <img src="<?php echo base_url('')?>/assets/img/bg-img/android.svg" alt="" data-animation="slideInRight" data-delay="400ms">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="welcome-content h-100">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="welcome-thumbnail">
                                    <img src="<?php echo base_url('')?>/assets/img/bg-img/d.svg" alt="" data-animation="slideInRight" data-delay="400ms">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="welcome-content h-100">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="welcome-thumbnail">
                                    <img src="<?php echo base_url('')?>/assets/img/bg-img/f.svg" alt="" data-animation="slideInRight" data-delay="400ms">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-6">
                    <div class="about-us-content mb-80">
                        ...
                        <p>At vero eos et accusam et justo duo dolores et ea rebum. Stet gubergren no sea takimata sanctus est Lorem ipsum dolor sit amet ipsumlor eut consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt labore et dolore magna
                            liquyam erat.</p>
                        <a href="<?php echo site_url('Testing')?>" class="btn uza-btn btn-2 mt-4">Test</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="uza-portfolio-area section-padding-80">
            ...
            <div class="row">
                ...
                <div class="portfolio-sildes owl-carousel">
                    ...
                    <div class="single-portfolio-slide">
                        <img src="<?php echo base_url('')?>/assets/img/bg-img/3.jpg" alt="">
                        <!-- Overlay Effect -->
                        ...
                        <div class="testimonial-slides owl-carousel">
                            ...
                            <div class="single-testimonial-slide d-flex align-items-center">
                                ...
                                <div class="testimonial-content">
                                    ...
                                    <!-- Quote Icon -->
                                    <div class="quote-icon"><img src="<?php echo base_url('')?>/assetsimg/core-img/quote.png" alt=""></div>
                                </div>
                            </div>
        ...
        <div class="portfolio-bg-curve">
            <img src="<?php echo base_url('')?>/assets/img/core-img/curve-3.png" alt="">
        </div>
    </section>
    <!-- ***** Portfolio Area End ***** -->
    ...
    <section class="uza-blog-area">
        ...
        <div class="blog-bg-curve">
            <img src="<?php echo base_url('')?>/assets/img/core-img/curve-4.png" alt="">
        </div>
